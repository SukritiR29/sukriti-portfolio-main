...
export default function About() {
  ...
  <div>
   <div className="stick lg:ml-20 lg:mr-20 ">
    ...
    <p className="mt-5 mr-5 text-base-100 text-md text-justify">A programmer with an ardent passion for Web Developing and Data Structures. To develop my talents & knowledge and learn more about my subject of study, I have worked on a numerous impactful projects, several internships & hackathons. I continue to fervently learn about relevant topics while actively working and learning in the field of Full-Stack Development, and its derivatives.</p>
   </div>

    <div className="lg:m-20 lg:mb-10 lg:mt-5 ">
...
and ethers.js. Implemented a one-click login flow. Used nonce and JWT to authenticate users. Employed ethers.js library to facilitate cryptographic operations.</p>
    ...
    <div className="lg:m-20 lg:mt-5 ">
      ...
      <div className="bg-secondary lg:w-80 mt-5 rounded-md">
        ...
        <p className="text-xs mt-2 text-justify pl-3 pr-3 text-slate-400 font-light">Consistently working on web projects and internships and deploying them relevant to the field, all of which could be viewed on the projects section.</p>
        </div>
      </div>
      ...
      <div className="bg-secondary lg:w-80 mt-5 rounded-md">
        ...
        <p className="text-xs mt-2 text-justify pl-3 pr-3 text-slate-400 font-light">Contributing to the community with Google Developers Students CLub as a UI Lead for 2 years. Conducting workshops on UI UX development and related challenges.</p>
        </div>
      </div>
      </div>
