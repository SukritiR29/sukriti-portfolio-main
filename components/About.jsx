  ...
  <div>
   <div className="stick lg:ml-20 lg:mr-20 ">
    ...
    <div className="lg:m-20 lg:mb-10 lg:mt-10  mr-3 ml-3">
      <h2  className="text-xl font-semibold  uppercase underline">Experience</h2>
...
and ethers.js. Implemented a one-click login flow. Used nonce and JWT to authenticate users. Employed ethers.js library to facilitate cryptographic operations.</p>
    ...
    <div className="lg:m-20 lg:mt-5 mr-3 ml-3">
      <h2  className="text-xl font-semibold uppercase underline">What I'm Doing</h2>
      <div className="lg:flex gap-20">
      <div className="bg-accent lg:w-80 mt-5 rounded-md">
    ...
    <div className="lg:flex gap-20">
      <div className="bg-accent lg:w-80 rounded-md">
        <div className="flex flex-col items-center justify-center pt-5 ">
